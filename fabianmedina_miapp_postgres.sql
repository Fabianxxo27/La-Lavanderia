-- PostgreSQL Dump (convertido desde MySQL)
-- Base de datos: fabianmedina_miapp
...
CREATE TABLE "codigo_barras" (
  ...
  "id_prenda" integer NOT NULL REFERENCES "prenda"("id_prenda") ON DELETE CASCADE
);
...
-- ========================================
-- Establecer secuencias con los valores actuales
-- ========================================
SELECT setval('"usuario_id_usuario_seq"', 28);
SELECT setval('"cliente_id_cliente_seq"', 5);
SELECT setval('"pedido_id_pedido_seq"', 8);
SELECT setval('"prenda_id_prenda_seq"', 3);
SELECT setval('"recibo_id_recibo_seq"', 2);
SELECT setval('"promocion_id_promocion_seq"', 1);
SELECT setval('"codigo_barras_id_codigo_seq"', 1);
SELECT setval('"imagen_id_imagen_seq"', 1);
SELECT setval('"reporte_id_reporte_seq"', 1);
SELECT setval('"historial_operaciones_id_operacion_seq"', 1);
