...
def generar_recibo(id_pedido):
    ...
    try:
        ...
        style_title = ParagraphStyle('ReciboTitle', parent=styles['Title'],
                                     fontSize=20, textColor=brand_dark,
                                     alignment=TA_CENTER, spaceAfter=4)
        style_subtitle = ParagraphStyle('ReciboSub', parent=styles['Normal'],
                                        fontSize=9, textColor=text_gray,
                                        alignment=TA_CENTER, spaceAfter=6)
        style_section = ParagraphStyle('ReciboSection', parent=styles['Heading3'],
                                       fontSize=11, textColor=brand_dark,
                                       spaceBefore=14, spaceAfter=6)
        style_footer = ParagraphStyle('ReciboFooter', parent=styles['Normal'],
        ...
        story.append(Paragraph(f"Recibo de pedido #{pedido[0]}", ParagraphStyle(
            'ReciboNum', parent=styles['Normal'], fontSize=10,
        ...
        if recibo:
            ...
            if descuento_monto > 0:
                desc_row = 1
                totales_styles.extend([
                    ('TEXTCOLOR', (1, desc_row), (1, desc_row), colors.HexColor('#c0392b')),
                    ('FONTNAME', (0, desc_row), (-1, desc_row), 'Helvetica-Oblique'),
                ])
